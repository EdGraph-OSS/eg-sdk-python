...
*SettingsApi* | [**get_tenant_setting_by_code**](docs/SettingsApi.md#get_tenant_setting_by_code) | **GET** /tenants/{tenantId}/tenantsettings/{code} | Retrieves a Tenant&#39;s settings by code.
