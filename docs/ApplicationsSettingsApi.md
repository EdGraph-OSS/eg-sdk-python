...
[**get_client_settings_by_code_async**](ApplicationsSettingsApi.md#get_client_settings_by_code_async) | **GET** /tenants/{tenantId}/clients/{clientId}/settings/{code} | Retrieves a Tenant&#39;s ClientSetting by code.
...
[**set_client_settings_by_code_async**](ApplicationsSettingsApi.md#set_client_settings_by_code_async) | **POST** /tenants/{tenantId}/clients/{clientId}/settings/{code} | Creates/updates a Tenant&#39;s ClientSetting by code.


# **get_client_settings_async**
> TenantApiTenantV1GetAppSettingsResponse get_client_settings_async(tenant_id, client_id, page_index=page_index, page_size=page_size, order_by=order_by, filter=filter)
...
async with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a list of a Tenant's ClientSettings.
        api_response = await api_instance.get_client_settings_async(tenant_id, client_id, page_index=page_index, page_size=page_size, order_by=order_by, filter=filter)
...
# **get_client_settings_by_code_async**
> TenantApiTenantV1TenantAppSettings get_client_settings_by_code_async(tenant_id, client_id, code)
...
async with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a Tenant's ClientSetting by code.
        api_response = await api_instance.get_client_settings_by_code_async(tenant_id, client_id, code)
        print("The response of ApplicationsSettingsApi->get_client_settings_by_code_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApplicationsSettingsApi->get_client_settings_by_code_async: %s\n" % e)
```
...
async with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a list of ClientSettingsTypes.
        api_response = await api_instance.get_client_settings_types_async(tenant_id, client_id, page_index=page_index, page_size=page_size, order_by=order_by, filter=filter)
...
async with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates/updates a Tenant's ClientSettings.
        api_response = await api_instance.set_client_settings_async(tenant_id, client_id, tenant_api_tenant_v1_set_app_settings_request=tenant_api_tenant_v1_set_app_settings_request)
...
# **set_client_settings_by_code_async**
> TenantApiTenantV1SetAppSettingsResponse set_client_settings_by_code_async(tenant_id, client_id, code, tenant_api_tenant_v1_set_app_settings_request=tenant_api_tenant_v1_set_app_settings_request)
...
async with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates/updates a Tenant's ClientSetting by code.
        api_response = await api_instance.set_client_settings_by_code_async(tenant_id, client_id, code, tenant_api_tenant_v1_set_app_settings_request=tenant_api_tenant_v1_set_app_settings_request)
        print("The response of ApplicationsSettingsApi->set_client_settings_by_code_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ApplicationsSettingsApi->set_client_settings_by_code_async: %s\n" % e)
```
