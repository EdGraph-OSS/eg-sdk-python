# edgraph_platform_client.ChangeLogsApi

All URIs are relative to *https://api.dev.edgraph.com/tenant*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_all_changes_async**](ChangeLogsApi.md#get_all_changes_async) | **GET** /tenants/{tenantId}/changes | 
...
async with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    api_instance = edgraph_platform_client.ChangeLogsApi(api_client)
    ...
    try:
        api_response = await api_instance.get_all_changes_async(tenant_id, page_size=page_size, page_index=page_index, order_by=order_by, filter=filter)
        print("The response of ChangeLogsApi->get_all_changes_async:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ChangeLogsApi->get_all_changes_async: %s\n" % e)
```
