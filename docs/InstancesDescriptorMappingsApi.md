...
[**export_descriptor_mappings**](InstancesDescriptorMappingsApi.md#export_descriptor_mappings) | **GET** /tenants/{tenantId}/edfiadmin/instances/{instanceId}/years/{year}/descriptorMappings/export | Exports all Descriptor Mappings as a JSON file.
...
[**import_descriptor_mappings**](InstancesDescriptorMappingsApi.md#import_descriptor_mappings) | **POST** /tenants/{tenantId}/edfiadmin/instances/{instanceId}/years/{year}/descriptorMappings/import | Imports Descriptor Mappings from a JSON file.
...
async with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a Descriptor Mapping.
        api_response = await api_instance.create_descriptor_mapping(tenant_id, instance_id, year, edfi_admin_api_edfi_admin_v1_create_descriptor_mapping_request=edfi_admin_api_edfi_admin_v1_create_descriptor_mapping_request)
...
async with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes a Descriptor Mapping.
        await api_instance.delete_descriptor_mapping(tenant_id, instance_id, year, descriptor_mapping_id)
    except Exception as e:
...
# **export_descriptor_mappings**
> export_descriptor_mappings(tenant_id, instance_id, year, namespace=namespace)
...
async with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Exports all Descriptor Mappings as a JSON file.
        await api_instance.export_descriptor_mappings(tenant_id, instance_id, year, namespace=namespace)
    except Exception as e:
        print("Exception when calling InstancesDescriptorMappingsApi->export_descriptor_mappings: %s\n" % e)
```
...
async with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a Descriptor Mapping by ID.
        api_response = await api_instance.get_descriptor_mapping_by_id(tenant_id, instance_id, year, descriptor_mapping_id)
...
async with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a list of Descriptors Mappings.
        api_response = await api_instance.get_descriptor_mappings(tenant_id, instance_id, year, page_size=page_size, page_index=page_index, namespace=namespace)
...
# **import_descriptor_mappings**
> import_descriptor_mappings(tenant_id, instance_id, year, file=file)
...
async with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Imports Descriptor Mappings from a JSON file.
        await api_instance.import_descriptor_mappings(tenant_id, instance_id, year, file=file)
    except Exception as e:
        print("Exception when calling InstancesDescriptorMappingsApi->import_descriptor_mappings: %s\n" % e)
```
...
async with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a Descriptor Mapping.
        api_response = await api_instance.update_descriptor_mapping(tenant_id, instance_id, year, descriptor_mapping_id, edfi_admin_api_edfi_admin_v1_update_descriptor_mapping_request=edfi_admin_api_edfi_admin_v1_update_descriptor_mapping_request)
