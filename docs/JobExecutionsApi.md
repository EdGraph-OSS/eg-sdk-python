...
------------- | ------------- | -------------
[**get_all_tenant_data_sync_job_executions**](JobExecutionsApi.md#get_all_tenant_data_sync_job_executions) | **GET** /tenants/{tenantId}/datasync/jobs/{jobId}/executions | Retrieves a list of DataSync Job Executions
...
# **get_all_tenant_data_sync_job_executions**
> DataSyncApiJobExecutionV1JobExecutionListResponsePaginatedItemsViewModel get_all_tenant_data_sync_job_executions(tenant_id, job_id, page_size=page_size, page_index=page_index, order_by=order_by, filter=filter)
...
async with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a list of DataSync Job Executions
        api_response = await api_instance.get_all_tenant_data_sync_job_executions(tenant_id, job_id, page_size=page_size, page_index=page_index, order_by=order_by, filter=filter)
        print("The response of JobExecutionsApi->get_all_tenant_data_sync_job_executions:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling JobExecutionsApi->get_all_tenant_data_sync_job_executions: %s\n" % e)
```
...
async with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets job executions by a given job Id
        api_response = await api_instance.get_tenant_job_executions_by_job_id(tenant_id, job_id, page_size=page_size, page_index=page_index, order_by=order_by, filter=filter)
