...
class AnalyticsDataLakeApi:
    ...
    def get_paginated_lakehouse_records(
        ...
        _param = self._get_paginated_lakehouse_records_serialize(
            tenant_id=tenant_id,
            page_size=page_size,
    ...
    def get_paginated_lakehouse_records_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AnalyticsApiLakehousesV1PaginatedLakehouseRecordsResponse]:
        """Retrieves gold-tier data from the lakehouse
    ...
    def _get_paginated_lakehouse_records_serialize(
        self,
        tenant_id,
        page_size,
        page_index,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/analytics/datalake/query',
