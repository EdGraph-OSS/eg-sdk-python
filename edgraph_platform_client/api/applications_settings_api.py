...
class ApplicationsSettingsApi:
    ...
    def _get_client_settings_async_serialize(
        self,
        tenant_id,
        client_id,
        _request_auth,
    ...
    def get_client_settings_types_async(
        ...
        _param = self._get_client_settings_types_async_serialize(
            tenant_id=tenant_id,
            client_id=client_id,
    ...
    def _get_client_settings_types_async_serialize(
        self,
        tenant_id,
        client_id,
        page_index,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/clients/{clientId}/settingstypes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def set_client_settings_async(
        ...
        _param = self._set_client_settings_async_serialize(
            tenant_id=tenant_id,
            client_id=client_id,
    ...
    def _set_client_settings_async_serialize(
        self,
        tenant_id,
        client_id,
