...
class ApplicationsTilesApi:
    ...
    async def get_tenant_application_tiles_async(
        ...
        _param = self._get_tenant_application_tiles_async_serialize(
            tenant_id=tenant_id,
    ...
    def _get_tenant_application_tiles_async_serialize(
        self,
        tenant_id,
        page_index,
        page_size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/applicationtiles',
