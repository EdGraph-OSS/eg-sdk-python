...
class ChangeLogsApi:
    ...
    @validate_call
    async def get_all_changes_async(
        self,
        tenant_id: StrictStr,
        ...
        _param = self._get_all_changes_async_serialize(
            tenant_id=tenant_id,
            page_size=page_size,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "ChangeLogChangeV1ChangeLogResponsePaginatedItemsViewModel",
    ...
    @validate_call
    async def get_all_changes_async_with_http_info(
        self,
        tenant_id: StrictStr,
        page_size: Optional[StrictInt] = None,
        page_index: Optional[StrictInt] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ChangeLogChangeV1ChangeLogResponsePaginatedItemsViewModel]:
        """get_all_changes_async
    ...
    @validate_call
    async def get_all_changes_async_without_preload_content(
        self,
        tenant_id: StrictStr,
        page_size: Optional[StrictInt] = None,
        page_index: Optional[StrictInt] = None,
    ...
    def _get_all_changes_async_serialize(
        self,
        tenant_id,
        page_size,
        page_index,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/changes',
