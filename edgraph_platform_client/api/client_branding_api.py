...
class ClientBrandingApi:
    ...
    @validate_call
    async def get_client_branding_async(
        self,
        client_id: Annotated[StrictStr, Field(description="The OAuth client id (already URL-decoded by routing).")],
        ...
        :param client_id: The OAuth client id (already URL-decoded by routing). (required)
        :type client_id: str
        ...
        _param = self._get_client_branding_async_serialize(
            client_id=client_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "EdGraphPlatformHttpAggregatorsTenantApiControllersV1ViewModelsResponsesClientBrandingResponse",
        }
    ...
    @validate_call
    async def get_client_branding_async_with_http_info(
        self,
        client_id: Annotated[StrictStr, Field(description="The OAuth client id (already URL-decoded by routing).")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EdGraphPlatformHttpAggregatorsTenantApiControllersV1ViewModelsResponsesClientBrandingResponse]:
        """Public (unauthenticated) read of a client's branding for the sign-in and other pre-auth  surfaces (Azure DevOps #17086). Returns only render fields + the override flag — never secrets,  storage internals, or other client configuration.
    ...
    @validate_call
    async def get_client_branding_async_without_preload_content(
        self,
        client_id: Annotated[StrictStr, Field(description="The OAuth client id (already URL-decoded by routing).")],
        _request_timeout: Union[
            None,
    ...
    def _get_client_branding_async_serialize(
        self,
        client_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/clients/{clientId}/branding',
