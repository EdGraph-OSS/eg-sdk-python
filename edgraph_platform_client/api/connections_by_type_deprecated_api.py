...
class ConnectionsByTypeDEPRECATEDApi:
    ...
    @validate_call
    async def create_or_update_state_reporting_connection_by_type_v1(
        self,
        tenant_id: UUID,
        ...
        _param = self._create_or_update_state_reporting_connection_by_type_v1_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    async def create_or_update_state_reporting_connection_by_type_v1_with_http_info(
        self,
        tenant_id: UUID,
        connection_type: StrictStr,
        ed_graph_http_aggregators_tenant_api_services_state_reporting_v1_create_connection_request: Optional[EdGraphHttpAggregatorsTenantApiServicesStateReportingV1CreateConnectionRequest] = None,
    ...
    @validate_call
    async def create_or_update_state_reporting_connection_by_type_v1_without_preload_content(
        self,
        tenant_id: UUID,
        connection_type: StrictStr,
        ed_graph_http_aggregators_tenant_api_services_state_reporting_v1_create_connection_request: Optional[EdGraphHttpAggregatorsTenantApiServicesStateReportingV1CreateConnectionRequest] = None,
    ...
    def _create_or_update_state_reporting_connection_by_type_v1_serialize(
        self,
        tenant_id,
        connection_type,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/tenants/{tenantId}/statereporting/connectionsByType/{connectionType}',
    ...
    @validate_call
    async def delete_state_reporting_by_type_connection_v1(
        self,
        tenant_id: UUID,
        connection_type: StrictStr,
        _request_timeout: Union[
        ...
        _param = self._delete_state_reporting_by_type_connection_v1_serialize(
            tenant_id=tenant_id,
            connection_type=connection_type,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def delete_state_reporting_by_type_connection_v1_with_http_info(
        self,
        tenant_id: UUID,
        connection_type: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    async def delete_state_reporting_by_type_connection_v1_without_preload_content(
        self,
        tenant_id: UUID,
        connection_type: StrictStr,
        _request_timeout: Union[
    ...
    def _delete_state_reporting_by_type_connection_v1_serialize(
        self,
        tenant_id,
        connection_type,
        _request_auth,
    ...
    @validate_call
    async def get_state_reporting_connection_by_type_v1(
        self,
        tenant_id: UUID,
        connection_type: StrictStr,
        _request_timeout: Union[
        ...
        _param = self._get_state_reporting_connection_by_type_v1_serialize(
            tenant_id=tenant_id,
            connection_type=connection_type,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def get_state_reporting_connection_by_type_v1_with_http_info(
        self,
        tenant_id: UUID,
        connection_type: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_state_reporting_connection_by_type_v1_without_preload_content(
        self,
        tenant_id: UUID,
        connection_type: StrictStr,
        _request_timeout: Union[
    ...
    def _get_state_reporting_connection_by_type_v1_serialize(
        self,
        tenant_id,
        connection_type,
        _request_auth,
