...
class EnrollmentAdminCapacityApi:
    ...
    async def get_capacity(
        ...
        grade: Annotated[Optional[StrictStr], Field(description="Optional exact match.")] = None,
        ...
        :param filter: 
        :type filter: str
        :param grade: Optional exact match.
        :type grade: str
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "EdGraphHttpAggregatorsTenantApiControllersV1ViewModelsResponsesEnrollmentAdminCapacityListItemDtoPaginatedItemsViewModel",
    ...
    async def get_capacity_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EdGraphHttpAggregatorsTenantApiControllersV1ViewModelsResponsesEnrollmentAdminCapacityListItemDtoPaginatedItemsViewModel]:
        """Searches Capacity for one school - one row per program x grade x school year.
