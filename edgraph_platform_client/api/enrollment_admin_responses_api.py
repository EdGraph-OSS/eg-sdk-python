...
class EnrollmentAdminResponsesApi:
    ...
    @validate_call
    async def get_enrollment_application_response(
        self,
        tenant_id: StrictStr,
        ...
        _param = self._get_enrollment_application_response_serialize(
            tenant_id=tenant_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "EnrollmentApiEnrollmentApplicationResponsesV1ApplicationResponseResponse",
    ...
    @validate_call
    async def get_enrollment_application_response_with_http_info(
        self,
        tenant_id: StrictStr,
        response_id: StrictStr,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EnrollmentApiEnrollmentApplicationResponsesV1ApplicationResponseResponse]:
        """Gets an Enrollment Application Response.
    ...
    @validate_call
    async def get_enrollment_application_response_without_preload_content(
        self,
        tenant_id: StrictStr,
        response_id: StrictStr,
        _request_timeout: Union[
    ...
    def _get_enrollment_application_response_serialize(
        self,
        tenant_id,
        response_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/enrollmentadmin/responses/{responseId}',
    ...
    @validate_call
    async def get_enrollment_application_responses(
        self,
        tenant_id: StrictStr,
        ...
        _param = self._get_enrollment_application_responses_serialize(
            tenant_id=tenant_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '403': "EdGraphCommonErrorsCoreProblemDetails",
            '500': "EdGraphCommonErrorsCoreProblemDetails",
            '200': "EnrollmentApiEnrollmentApplicationResponsesV1ApplicationResponsesSearchResponse",
        }
        response_data = await self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    async def get_enrollment_application_responses_with_http_info(
        self,
        tenant_id: StrictStr,
        page_index: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EnrollmentApiEnrollmentApplicationResponsesV1ApplicationResponsesSearchResponse]:
        """Searches Enrollment Application Responses.
    ...
    @validate_call
    async def get_enrollment_application_responses_without_preload_content(
        self,
        tenant_id: StrictStr,
        page_index: Optional[StrictInt] = None,
        page_size: Optional[StrictInt] = None,
    ...
    def _get_enrollment_application_responses_serialize(
        self,
        tenant_id,
        page_index,
        page_size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/enrollmentadmin/responses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
