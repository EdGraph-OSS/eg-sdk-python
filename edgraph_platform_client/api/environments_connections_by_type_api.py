...
class EnvironmentsConnectionsByTypeApi:
    ...
    @validate_call
    async def create_or_update_state_reporting_connection_by_type(
        self,
        tenant_id: UUID,
        environment_id: UUID,
        ...
        _param = self._create_or_update_state_reporting_connection_by_type_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    async def create_or_update_state_reporting_connection_by_type_with_http_info(
        self,
        tenant_id: UUID,
        environment_id: UUID,
        connection_type: StrictStr,
    ...
    @validate_call
    async def create_or_update_state_reporting_connection_by_type_without_preload_content(
        self,
        tenant_id: UUID,
        environment_id: UUID,
        connection_type: StrictStr,
    ...
    def _create_or_update_state_reporting_connection_by_type_serialize(
        self,
        tenant_id,
        environment_id,
        connection_type,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/tenants/{tenantId}/statereporting/environments/{environmentId}/connectionsByType/{connectionType}',
    ...
    @validate_call
    async def delete_state_reporting_by_type_connection(
        self,
        tenant_id: UUID,
        environment_id: UUID,
        connection_type: StrictStr,
        ...
        _param = self._delete_state_reporting_by_type_connection_serialize(
            tenant_id=tenant_id,
            environment_id=environment_id,
            connection_type=connection_type,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def delete_state_reporting_by_type_connection_with_http_info(
        self,
        tenant_id: UUID,
        environment_id: UUID,
        connection_type: StrictStr,
    ...
    @validate_call
    async def delete_state_reporting_by_type_connection_without_preload_content(
        self,
        tenant_id: UUID,
        environment_id: UUID,
        connection_type: StrictStr,
    ...
    def _delete_state_reporting_by_type_connection_serialize(
        self,
        tenant_id,
        environment_id,
        connection_type,
    ...
    @validate_call
    async def get_state_reporting_connection_by_type(
        self,
        tenant_id: UUID,
        environment_id: UUID,
        connection_type: StrictStr,
        ...
        _param = self._get_state_reporting_connection_by_type_serialize(
            tenant_id=tenant_id,
            environment_id=environment_id,
            connection_type=connection_type,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def get_state_reporting_connection_by_type_with_http_info(
        self,
        tenant_id: UUID,
        environment_id: UUID,
        connection_type: StrictStr,
    ...
    @validate_call
    async def get_state_reporting_connection_by_type_without_preload_content(
        self,
        tenant_id: UUID,
        environment_id: UUID,
        connection_type: StrictStr,
    ...
    def _get_state_reporting_connection_by_type_serialize(
        self,
        tenant_id,
        environment_id,
        connection_type,
