...
class InstancesAuthorizationStrategiesApi:
    ...
    def get_authorization_strategies_async(
        ...
        _param = self._get_authorization_strategies_async_serialize(
            tenant_id=tenant_id,
    ...
    def get_authorization_strategies_async_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EdfiAdminApiEdfiAdminV1AuthorizationStrategiesResponse]:
        """Retrieves a list of Authorization Strategies.
    ...
    def _get_authorization_strategies_async_serialize(
        self,
        tenant_id,
        instance_id,
        page_index,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/edfiadmin/instances/{instanceId}/authorizationstrategies',
