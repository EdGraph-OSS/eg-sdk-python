...
class JobExecutionLogsApi:
    ...
    def get_all_tenant_data_sync_job_execution_logs(
        ...
        _param = self._get_all_tenant_data_sync_job_execution_logs_serialize(
            tenant_id=tenant_id,
            job_id=job_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "DataSyncApiJobExecutionLogV1JobExecutionLogEntryPaginatedItemsViewModel",
    ...
    def _get_all_tenant_data_sync_job_execution_logs_serialize(
        self,
        tenant_id,
        job_id,
        job_execution_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/datasync/jobs/{jobId}/executions/{jobExecutionId}/logs',
