...
class LogsApi:
    ...
    async def get_logs(
        ...
        job_execution_id: Optional[StrictStr] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '200': "ValidationsApiValidationResultsV1FindResponse",
    ...
    async def get_logs_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ValidationsApiValidationResultsV1FindResponse]:
        """Retrieves a list of Logs.
    ...
    def _get_logs_serialize(
        ...
        if job_execution_id is not None:
            ...
            _query_params.append(('jobExecutionId', job_execution_id))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/validations/logs',
