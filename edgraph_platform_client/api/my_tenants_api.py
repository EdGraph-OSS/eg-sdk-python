...
class MyTenantsApi:
    ...
    async def get_user_tenants(
        ...
        _param = self._get_user_tenants_serialize(
    ...
    async def get_user_tenants_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IdentityApiUserV1UserTenantProfilePaginatedItemsViewModel]:
        """Retrieves the Tenants of the User that is currently logged in.
    ...
    def _get_user_tenants_serialize(
        self,
        page_index,
        page_size,
        filter,
    ...
    async def search_my_licenses(
        ...
        _param = self._search_my_licenses_serialize(
            tenant_id=tenant_id,
            page_index=page_index,
            page_size=page_size,
            filter=filter,
    ...
    async def search_my_licenses_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IdentityApiUserV2UserMeTenantsResponsePaginatedItemsViewModel]:
        """Search the user's licenses.
    ...
    def _search_my_licenses_serialize(
        self,
        tenant_id,
        page_index,
        page_size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/me/tenants/{tenantId}/licenses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def search_my_tenants(
        ...
        _param = self._search_my_tenants_serialize(
            page_index=page_index,
            page_size=page_size,
            filter=filter,
            order_by=order_by,
    ...
    def _search_my_tenants_serialize(
        self,
        page_index,
        page_size,
        filter,
