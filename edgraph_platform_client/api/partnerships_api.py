...
class PartnershipsApi:
    ...
    def get_all_partnerships(
        ...
        partner_tenant_id: Optional[StrictStr] = None,
        partnership_type: Optional[List[StrictStr]] = None,
        ...
        :param order_by: 
        :type order_by: str
        :param partner_tenant_id: 
        :type partner_tenant_id: str
        :param partnership_type: 
        :type partnership_type: List[str]
        ...
        _param = self._get_all_partnerships_serialize(
            tenant_id=tenant_id,
    ...
    def get_all_partnerships_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TenantApiPartnershipV1PaginatedItemsResponse]:
        """Retrieves a list of Partnerships.
    ...
    def _get_all_partnerships_serialize(
        self,
        tenant_id,
        page_index,
        page_size,
        ...
        if partner_tenant_id is not None:
            ...
            _query_params.append(('partnerTenantId', partner_tenant_id))
            
        if partnership_type is not None:
            
            _query_params.append(('partnershipType', partnership_type))
            
        if exclude_soft_deleted is not None:
            
            _query_params.append(('excludeSoftDeleted', exclude_soft_deleted))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/partnerships',
    ...
    def get_partnership_by_id(
        ...
        _param = self._get_partnership_by_id_serialize(
            tenant_id=tenant_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '403': "EdGraphCommonErrorsCoreProblemDetails",
            '500': "EdGraphCommonErrorsCoreProblemDetails",
            '200': "TenantApiPartnershipV1PartnershipByIdResponse",
            '400': "MicrosoftAspNetCoreMvcValidationProblemDetails",
    ...
    def get_partnership_by_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TenantApiPartnershipV1PartnershipByIdResponse]:
        """Retrieves a Partnership by ID.
    ...
    def _get_partnership_by_id_serialize(
        self,
        tenant_id,
        partnership_id,
        exclude_soft_deleted,
        ...
        if partnership_id is not None:
            _path_params['partnershipId'] = partnership_id
        # process the query parameters
        if exclude_soft_deleted is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/partnerships/{partnershipId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
