...
class ProvidersApi:
    ...
    @validate_call
    async def get_all_tenant_data_sync_providers(
        self,
        tenant_id: StrictStr,
    ...
    @validate_call
    async def get_all_tenant_data_sync_providers_with_http_info(
        self,
        tenant_id: StrictStr,
        page_size: Optional[StrictInt] = None,
        page_index: Optional[StrictInt] = None,
    ...
    @validate_call
    async def get_all_tenant_data_sync_providers_without_preload_content(
        self,
        tenant_id: StrictStr,
        page_size: Optional[StrictInt] = None,
        page_index: Optional[StrictInt] = None,
    ...
    @validate_call
    async def get_tenant_data_sync_provider_profile_by_id(
        self,
        tenant_id: StrictStr,
    ...
    @validate_call
    async def get_tenant_data_sync_provider_profile_by_id_with_http_info(
        self,
        tenant_id: StrictStr,
        provider_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_tenant_data_sync_provider_profile_by_id_without_preload_content(
        self,
        tenant_id: StrictStr,
        provider_id: StrictStr,
        _request_timeout: Union[
