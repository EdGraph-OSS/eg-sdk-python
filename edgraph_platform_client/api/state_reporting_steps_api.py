...
class StateReportingStepsApi:
    ...
    def get_steps(
        ...
        _param = self._get_steps_serialize(
            tenant_id=tenant_id,
    ...
    def get_steps_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ValidationsApiStateReportingStepsV1GetStateReportingStepsResponse]:
        """Get Steps Status for the tenant.
    ...
    def _get_steps_serialize(
        ...
        if school_year is not None:
            _path_params['schoolYear'] = school_year
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/statereporting/schoolYear/{schoolYear}/steps',
    ...
    def update_step(
        ...
        :type validations_api_state_reporting_steps_v1_update_state_reporting_step_request: ValidationsApiStateReportingStepsV1UpdateStateReportingStepRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_step_serialize(
            tenant_id=tenant_id,
            school_year=school_year,
            validations_api_state_reporting_steps_v1_update_state_reporting_step_request=validations_api_state_reporting_steps_v1_update_state_reporting_step_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_step_serialize(
        self,
        tenant_id,
        school_year,
        validations_api_state_reporting_steps_v1_update_state_reporting_step_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if validations_api_state_reporting_steps_v1_update_state_reporting_step_request is not None:
            _body_params = validations_api_state_reporting_steps_v1_update_state_reporting_step_request
