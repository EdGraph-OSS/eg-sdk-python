...
class TenantBrandingApi:
    ...
    async def update_tenant_branding(
        ...
        _param = self._update_tenant_branding_serialize(
            tenant_id=tenant_id,
            logo_file=logo_file,
    ...
    def _update_tenant_branding_serialize(
        self,
        tenant_id,
        logo_file,
        background_file,
        ...
        if background_file is not None:
            _files['BackgroundFile'] = background_file
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/tenants/{tenantId}/branding',
