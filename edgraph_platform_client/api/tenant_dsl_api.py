...
class TenantDslApi:
    ...
    def create_dsl_sync(
        ...
        _param = self._create_dsl_sync_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def create_dsl_sync_with_http_info(
        self,
        tenant_id: StrictStr,
        data_sync_api_dsl_v1_create_job_request: Optional[DataSyncApiDslV1CreateJobRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def create_dsl_sync_without_preload_content(
        self,
        tenant_id: StrictStr,
        data_sync_api_dsl_v1_create_job_request: Optional[DataSyncApiDslV1CreateJobRequest] = None,
        _request_timeout: Union[
    ...
    def _create_dsl_sync_serialize(
        self,
        tenant_id,
    ...
    def execute_dsl_sync_job(
        ...
        _param = self._execute_dsl_sync_job_serialize(
            tenant_id=tenant_id,
            job_id=job_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def execute_dsl_sync_job_with_http_info(
        self,
        tenant_id: StrictStr,
        job_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def execute_dsl_sync_job_without_preload_content(
        self,
        tenant_id: StrictStr,
        job_id: StrictStr,
        _request_timeout: Union[
    ...
    def _execute_dsl_sync_job_serialize(
        self,
        tenant_id,
        job_id,
        _request_auth,
    ...
    def get_dsl_sync_data(
        ...
        _param = self._get_dsl_sync_data_serialize(
            tenant_id=tenant_id,
            job_id=job_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_dsl_sync_data_with_http_info(
        self,
        tenant_id: StrictStr,
        job_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def get_dsl_sync_data_without_preload_content(
        self,
        tenant_id: StrictStr,
        job_id: StrictStr,
        _request_timeout: Union[
    ...
    def _get_dsl_sync_data_serialize(
        self,
        tenant_id,
        job_id,
        _request_auth,
    ...
    def update_dsl_sync(
        ...
        _param = self._update_dsl_sync_serialize(
            tenant_id=tenant_id,
            job_id=job_id,
    ...
    @validate_call
    def update_dsl_sync_with_http_info(
        self,
        tenant_id: StrictStr,
        job_id: StrictStr,
        data_sync_api_dsl_v1_update_job_request: Optional[DataSyncApiDslV1UpdateJobRequest] = None,
    ...
    @validate_call
    def update_dsl_sync_without_preload_content(
        self,
        tenant_id: StrictStr,
        job_id: StrictStr,
        data_sync_api_dsl_v1_update_job_request: Optional[DataSyncApiDslV1UpdateJobRequest] = None,
    ...
    def _update_dsl_sync_serialize(
        self,
        tenant_id,
        job_id,
