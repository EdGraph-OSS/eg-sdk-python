...
class UsersSEOAAsApi:
    ...
    async def add_user_seoaa(
        ...
        _param = self._add_user_seoaa_serialize(
            tenant_id=tenant_id,
            user_id=user_id,
            ed_graph_http_aggregators_tenant_api_controllers_v2_requests_add_seoaa_request=ed_graph_http_aggregators_tenant_api_controllers_v2_requests_add_seoaa_request,
    ...
    async def add_user_seoaa_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IdentityApiUserV1SEOAAAddedResponse]:
        """Add User SEOAAs
    ...
    def _add_user_seoaa_serialize(
        self,
        tenant_id,
        user_id,
        ed_graph_http_aggregators_tenant_api_controllers_v2_requests_add_seoaa_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if ed_graph_http_aggregators_tenant_api_controllers_v2_requests_add_seoaa_request is not None:
            _body_params = ed_graph_http_aggregators_tenant_api_controllers_v2_requests_add_seoaa_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/tenants/{tenantId}/users/{userId}/seoaas',
    ...
    async def delete_user_seoaa(
        ...
        _param = self._delete_user_seoaa_serialize(
            tenant_id=tenant_id,
            user_id=user_id,
            seoaa_id=seoaa_id,
            _request_auth=_request_auth,
    ...
    async def delete_user_seoaa_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IdentityApiUserV1SEOAAUpdatedResponse]:
        """Delete User SEOAAs
    ...
    def _delete_user_seoaa_serialize(
        self,
        tenant_id,
        user_id,
        seoaa_id,
        ...
        if user_id is not None:
            _path_params['userId'] = user_id
        if seoaa_id is not None:
            _path_params['seoaaId'] = seoaa_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v2/tenants/{tenantId}/users/{userId}/seoaas/{seoaaId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def search_user_seoaa(
        ...
        _param = self._search_user_seoaa_serialize(
            tenant_id=tenant_id,
            user_id=user_id,
            page_size=page_size,
    ...
    async def search_user_seoaa_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IdentityApiUserV1GetSEOAAsResponse]:
        """Search User SEOAAs
    ...
    def _search_user_seoaa_serialize(
        self,
        tenant_id,
        user_id,
        page_size,
    ...
    async def update_user_seoaa(
        ...
        :type ed_graph_http_aggregators_tenant_api_controllers_v2_requests_update_seoaa_request: EdGraphHttpAggregatorsTenantApiControllersV2RequestsUpdateSeoaaRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_user_seoaa_serialize(
            tenant_id=tenant_id,
            user_id=user_id,
            seoaa_id=seoaa_id,
            ed_graph_http_aggregators_tenant_api_controllers_v2_requests_update_seoaa_request=ed_graph_http_aggregators_tenant_api_controllers_v2_requests_update_seoaa_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_user_seoaa_serialize(
        self,
        tenant_id,
        user_id,
        seoaa_id,
        ed_graph_http_aggregators_tenant_api_controllers_v2_requests_update_seoaa_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if ed_graph_http_aggregators_tenant_api_controllers_v2_requests_update_seoaa_request is not None:
            _body_params = ed_graph_http_aggregators_tenant_api_controllers_v2_requests_update_seoaa_request
