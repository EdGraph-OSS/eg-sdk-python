...
class V1Api:
    ...
    async def get_student_profile(
        ...
        _param = self._get_student_profile_serialize(
            tenant_id=tenant_id,
            id=id,
    ...
    @validate_call
    async def get_student_profile_with_http_info(
        self,
        tenant_id: UUID,
        id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    async def get_student_profile_without_preload_content(
        self,
        tenant_id: UUID,
        id: StrictStr,
        _request_timeout: Union[
    ...
    def _get_student_profile_serialize(
        self,
        tenant_id,
        id,
        _request_auth,
    ...
    async def get_students(
        ...
        pathway: Optional[StrictStr] = None,
    ...
    @validate_call
    async def get_students_with_http_info(
        self,
        tenant_id: UUID,
        campus: Optional[StrictStr] = None,
        pathway: Optional[StrictStr] = None,
    ...
    @validate_call
    async def get_students_without_preload_content(
        self,
        tenant_id: UUID,
        campus: Optional[StrictStr] = None,
        pathway: Optional[StrictStr] = None,
    ...
    async def release_user_lockout(
        ...
        _param = self._release_user_lockout_serialize(
            tenant_id=tenant_id,
            user_id=user_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    async def release_user_lockout_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IdentityApiUserV1ReleaseUserLockoutResponse]:
        """release_user_lockout
    ...
    def _release_user_lockout_serialize(
        self,
        tenant_id,
        user_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/tenants/{tenantId}/users/{userId}/releaselockout',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def update_student_contacts(
        self,
        tenant_id: UUID,
        ...
        _param = self._update_student_contacts_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    async def update_student_contacts_with_http_info(
        self,
        tenant_id: UUID,
        student_id: StrictStr,
        body: Optional[Any] = None,
    ...
    @validate_call
    async def update_student_contacts_without_preload_content(
        self,
        tenant_id: UUID,
        student_id: StrictStr,
        body: Optional[Any] = None,
    ...
    def _update_student_contacts_serialize(
        self,
        tenant_id,
        student_id,
        body,
