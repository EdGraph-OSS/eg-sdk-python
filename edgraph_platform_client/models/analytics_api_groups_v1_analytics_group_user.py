...
class AnalyticsApiGroupsV1AnalyticsGroupUser(BaseModel):
    """
    ...
    group_user_access_right: Optional[StrictStr] = Field(default=None, alias="groupUserAccessRight")
    identifier: Optional[StrictStr] = None
    principal_type: Optional[StrictStr] = Field(default=None, alias="principalType")
    __properties: ClassVar[List[str]] = ["displayName", "emailAddress", "groupUserAccessRight", "identifier", "principalType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if group_user_access_right (nullable) is None
        # and model_fields_set contains the field
        if self.group_user_access_right is None and "group_user_access_right" in self.model_fields_set:
            _dict['groupUserAccessRight'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groupUserAccessRight": obj.get("groupUserAccessRight"),
