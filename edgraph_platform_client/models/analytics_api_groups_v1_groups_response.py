...
class AnalyticsApiGroupsV1GroupsResponse(BaseModel):
    """
    AnalyticsApiGroupsV1GroupsResponse
    """ # noqa: E501
    groups: Optional[List[AnalyticsApiGroupsV1GroupResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [AnalyticsApiGroupsV1GroupResponse.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
