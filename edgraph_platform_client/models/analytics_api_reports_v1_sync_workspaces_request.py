...
class AnalyticsApiReportsV1SyncWorkspacesRequest(BaseModel):
    """
    ...
    reset_instance: Optional[StrictBool] = Field(default=None, alias="resetInstance")
    __properties: ClassVar[List[str]] = ["configurationId", "tenantId", "resetInstance"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if reset_instance (nullable) is None
        # and model_fields_set contains the field
        if self.reset_instance is None and "reset_instance" in self.model_fields_set:
            _dict['resetInstance'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resetInstance": obj.get("resetInstance")
        })
        return _obj
