...
class ChangeLogChangeV1ChangeLogResponsePaginatedItemsViewModel(BaseModel):
    """
    ...
    data: Optional[List[ChangeLogChangeV1ChangeLogResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "data": [ChangeLogChangeV1ChangeLogResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
