...
class DataSyncApiDslV1UpdateJobRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "jobId", "enabled", "dagWorkflow", "name", "startDate", "endDate", "cron", "timeZone"]
