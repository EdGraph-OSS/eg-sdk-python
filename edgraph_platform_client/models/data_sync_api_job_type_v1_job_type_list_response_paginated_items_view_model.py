...
class DataSyncApiJobTypeV1JobTypeListResponsePaginatedItemsViewModel(BaseModel):
    """
    ...
    data: Optional[List[DataSyncApiJobTypeV1JobTypeListResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "data": [DataSyncApiJobTypeV1JobTypeListResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
