...
class DataSyncApiProviderV1ProviderListResponsePaginatedItemsViewModel(BaseModel):
    """
    ...
    data: Optional[List[DataSyncApiProviderV1ProviderListResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "data": [DataSyncApiProviderV1ProviderListResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
