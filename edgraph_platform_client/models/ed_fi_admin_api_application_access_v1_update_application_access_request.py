...
class EdFiAdminApiApplicationAccessV1UpdateApplicationAccessRequest(BaseModel):
    """
    ...
    users: Optional[List[EdFiAdminApiApplicationAccessV1ApplicationUserAccessResponse]] = None
    __properties: ClassVar[List[str]] = ["id", "tenantId", "applicationId", "apiClientId", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": [EdFiAdminApiApplicationAccessV1ApplicationUserAccessResponse.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
