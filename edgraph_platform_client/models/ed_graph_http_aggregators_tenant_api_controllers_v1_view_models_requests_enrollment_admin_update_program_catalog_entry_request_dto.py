...
class EdGraphHttpAggregatorsTenantApiControllersV1ViewModelsRequestsEnrollmentAdminUpdateProgramCatalogEntryRequestDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "tenantId", "code", "name", "programType", "eligibilityCriteria", "requiredDocuments", "internalDisplayName"]
