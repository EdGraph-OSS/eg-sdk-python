...
class EdGraphHttpAggregatorsTenantApiControllersV1ViewModelsRequestsEnrollmentAdminUpdateSchoolProgramRequestDto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "tenantId", "code", "name", "programType", "eligibilityCriteria", "requiredDocuments", "grades", "capacityByGrade", "zone", "latitude", "longitude"]
