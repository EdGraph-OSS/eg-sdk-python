...
class EdGraphHttpAggregatorsTenantApiControllersV2ResponsesUserLicenseSearchResultBulk(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "licenses": EdGraphHttpAggregatorsTenantApiControllersV2ResponsesUserLicenseSearchResult.from_dict(obj["licenses"]) if obj.get("licenses") is not None else None
        })
        return _obj
