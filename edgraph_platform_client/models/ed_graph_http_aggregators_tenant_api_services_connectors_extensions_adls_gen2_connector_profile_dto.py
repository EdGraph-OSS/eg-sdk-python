...
class EdGraphHttpAggregatorsTenantApiServicesConnectorsExtensionsADLSGen2ConnectorProfileDTO(BaseModel):
    ...
    connector_name: Optional[StrictStr] = Field(default=None, alias="connectorName")
    workspace_name: Optional[StrictStr] = Field(default=None, alias="workspaceName")
    authentication_type: Optional[AnalyticsApiADLSGen2ConnectorsV1AuthenticationType] = Field(default=None, alias="authenticationType")
    pipeline: Optional[EdGraphHttpAggregatorsTenantApiServicesConnectorsExtensionsADLSGen2ConnectorProfilePipelineDTO] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.authentication_type:
            _dict['authenticationType'] = self.authentication_type.to_dict()
        ...
        # set to None if connector_type (nullable) is None
        # and model_fields_set contains the field
        if self.connector_type is None and "connector_type" in self.model_fields_set:
            _dict['connectorType'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "authenticationType": AnalyticsApiADLSGen2ConnectorsV1AuthenticationType.from_dict(obj["authenticationType"]) if obj.get("authenticationType") is not None else None,
            "pipeline": EdGraphHttpAggregatorsTenantApiServicesConnectorsExtensionsADLSGen2ConnectorProfilePipelineDTO.from_dict(obj["pipeline"]) if obj.get("pipeline") is not None else None,
