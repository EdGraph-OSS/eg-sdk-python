...
class EdGraphHttpAggregatorsTenantApiServicesConnectorsResponsesMappedConnectorListResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "tenantId", "connectorName", "connectorType", "createdBy", "createdDateTime", "isDeleted", "deletedBy", "deletedDateTime", "lastModifiedBy", "lastModifiedDateTime", "properties"]
