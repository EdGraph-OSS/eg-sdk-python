...
class EdGraphHttpAggregatorsTenantApiServicesObservationsAddAvailablePersonaRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "name", "description", "identifier", "isDefault"]
