...
class EdGraphHttpAggregatorsTenantApiServicesObservationsCreateObservationSubmissionRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["formId", "tenantId", "currentStep", "data", "observationId"]
