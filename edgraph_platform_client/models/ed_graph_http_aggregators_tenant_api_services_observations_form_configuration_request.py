...
class EdGraphHttpAggregatorsTenantApiServicesObservationsFormConfigurationRequest(BaseModel):
    """
    ...
    versions: Optional[List[EdGraphHttpAggregatorsTenantApiServicesObservationsFormVersionConfigurationRequest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [EdGraphHttpAggregatorsTenantApiServicesObservationsFormVersionConfigurationRequest.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
