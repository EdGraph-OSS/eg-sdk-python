...
class EdGraphHttpAggregatorsTenantApiServicesObservationsFormConfigurationResponse(BaseModel):
    """
    ...
    versions: Optional[List[EdGraphHttpAggregatorsTenantApiServicesObservationsFormVersionConfigurationResponse]] = None
    __properties: ClassVar[List[str]] = ["formId", "versions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [EdGraphHttpAggregatorsTenantApiServicesObservationsFormVersionConfigurationResponse.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
