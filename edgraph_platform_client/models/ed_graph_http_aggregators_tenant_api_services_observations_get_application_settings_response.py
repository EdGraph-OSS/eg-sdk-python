...
class EdGraphHttpAggregatorsTenantApiServicesObservationsGetApplicationSettingsResponse(BaseModel):
    """
    EdGraphHttpAggregatorsTenantApiServicesObservationsGetApplicationSettingsResponse
    """ # noqa: E501
    tenant_id: Optional[StrictStr] = Field(default=None, alias="tenantId")
    forms: Optional[List[EdGraphHttpAggregatorsTenantApiServicesObservationsFormConfigurationResponse]] = None
    __properties: ClassVar[List[str]] = ["tenantId", "forms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "forms": [EdGraphHttpAggregatorsTenantApiServicesObservationsFormConfigurationResponse.from_dict(_item) for _item in obj["forms"]] if obj.get("forms") is not None else None
        })
        return _obj
