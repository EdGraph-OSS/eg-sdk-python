...
class EdGraphHttpAggregatorsTenantApiServicesObservationsGetStaffClassificationSettingsResponse(BaseModel):
    """
    EdGraphHttpAggregatorsTenantApiServicesObservationsGetStaffClassificationSettingsResponse
    """ # noqa: E501
    tenant_id: Optional[StrictStr] = Field(default=None, alias="tenantId")
    namespaces: Optional[List[EdGraphHttpAggregatorsTenantApiServicesObservationsStaffClassificationNamespaceConfiguration]] = None
    __properties: ClassVar[List[str]] = ["tenantId", "namespaces"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "namespaces": [EdGraphHttpAggregatorsTenantApiServicesObservationsStaffClassificationNamespaceConfiguration.from_dict(_item) for _item in obj["namespaces"]] if obj.get("namespaces") is not None else None
        })
        return _obj
