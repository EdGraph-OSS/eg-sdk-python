...
class EdGraphHttpAggregatorsTenantApiServicesObservationsSetApplicationSettingsRequest(BaseModel):
    """
    EdGraphHttpAggregatorsTenantApiServicesObservationsSetApplicationSettingsRequest
    """ # noqa: E501
    tenant_id: Optional[StrictStr] = Field(default=None, alias="tenantId")
    forms: Optional[List[EdGraphHttpAggregatorsTenantApiServicesObservationsFormConfigurationRequest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "forms": [EdGraphHttpAggregatorsTenantApiServicesObservationsFormConfigurationRequest.from_dict(_item) for _item in obj["forms"]] if obj.get("forms") is not None else None
        })
        return _obj
