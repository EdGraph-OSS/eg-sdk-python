...
class EdGraphHttpAggregatorsTenantApiServicesObservationsUpsertDashboardPreferencesRequest(BaseModel):
    """
    ...
    preferences: Optional[List[EdGraphHttpAggregatorsTenantApiServicesObservationsUpsertReportPreferenceDetails]] = None
    __properties: ClassVar[List[str]] = ["tenantId", "dashboardId", "preferences"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "preferences": [EdGraphHttpAggregatorsTenantApiServicesObservationsUpsertReportPreferenceDetails.from_dict(_item) for _item in obj["preferences"]] if obj.get("preferences") is not None else None
        })
        return _obj
