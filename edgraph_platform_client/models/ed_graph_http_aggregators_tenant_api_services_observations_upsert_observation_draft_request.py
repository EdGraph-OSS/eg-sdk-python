...
class EdGraphHttpAggregatorsTenantApiServicesObservationsUpsertObservationDraftRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "formId", "tenantId", "currentStep", "data", "observationId"]
