...
class EdGraphHttpAggregatorsTenantApiServicesStateReportingV1ConnectionCreatedResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["connectionId", "tenantId", "environmentId"]
