...
class EdGraphHttpAggregatorsTenantApiServicesStateReportingV1CreateConnectionRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "tenantId", "environmentId", "server", "username", "database", "password", "authUrl", "resourcesUrl", "apiKey", "apiSecret"]
