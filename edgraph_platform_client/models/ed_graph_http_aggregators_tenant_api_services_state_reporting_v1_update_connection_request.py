...
class EdGraphHttpAggregatorsTenantApiServicesStateReportingV1UpdateConnectionRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "tenantId", "environmentId", "server", "username", "database", "password", "authUrl", "resourcesUrl", "apiKey", "apiSecret"]
