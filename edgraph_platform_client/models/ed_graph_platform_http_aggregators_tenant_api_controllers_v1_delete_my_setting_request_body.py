...
class EdGraphPlatformHttpAggregatorsTenantApiControllersV1DeleteMySettingRequestBody(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["settingTypeId", "provider", "applicationId", "reason"]
