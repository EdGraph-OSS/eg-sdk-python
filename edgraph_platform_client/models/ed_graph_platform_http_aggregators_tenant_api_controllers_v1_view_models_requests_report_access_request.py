...
class EdGraphPlatformHttpAggregatorsTenantApiControllersV1ViewModelsRequestsReportAccessRequest(BaseModel):
    """
    ...
    staff_classifications: Optional[List[StrictStr]] = Field(default=None, description="Targeted EdFi staff classifications (`namespace#codeValue`).", alias="staffClassifications")
    users: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["targetAudience", "staffClassifications", "users"]
