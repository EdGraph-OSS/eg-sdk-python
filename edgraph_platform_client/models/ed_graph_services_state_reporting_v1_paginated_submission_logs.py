...
class EdGraphServicesStateReportingV1PaginatedSubmissionLogs(BaseModel):
    """
    ...
    data: Optional[List[EdGraphServicesStateReportingV1SubmissionLog]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "data": [EdGraphServicesStateReportingV1SubmissionLog.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
