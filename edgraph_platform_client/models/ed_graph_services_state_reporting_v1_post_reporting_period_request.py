...
class EdGraphServicesStateReportingV1PostReportingPeriodRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "environmentId", "reportingPeriodId", "categoryIds"]
