...
class EdGraphServicesStateReportingV1ReportingPeriodCurrentStepSetResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "environmentId", "reportingPeriodId", "number"]
