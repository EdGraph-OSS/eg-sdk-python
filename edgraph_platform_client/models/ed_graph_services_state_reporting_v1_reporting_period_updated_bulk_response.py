...
class EdGraphServicesStateReportingV1ReportingPeriodUpdatedBulkResponse(BaseModel):
    """
    ...
    reporting_period_ids: Optional[List[StrictStr]] = Field(default=None, alias="reportingPeriodIds")
    __properties: ClassVar[List[str]] = ["tenantId", "environmentId", "reportingPeriodIds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if reporting_period_ids (nullable) is None
        # and model_fields_set contains the field
        if self.reporting_period_ids is None and "reporting_period_ids" in self.model_fields_set:
            _dict['reportingPeriodIds'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reportingPeriodIds": obj.get("reportingPeriodIds")
        })
        return _obj
