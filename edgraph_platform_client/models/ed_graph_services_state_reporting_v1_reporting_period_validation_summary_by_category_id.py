...
class EdGraphServicesStateReportingV1ReportingPeriodValidationSummaryByCategoryId(BaseModel):
    """
    ...
    sub_categories: Optional[List[EdGraphServicesStateReportingV1ValidationSummarySubCategory]] = Field(default=None, alias="subCategories")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subCategories": [EdGraphServicesStateReportingV1ValidationSummarySubCategory.from_dict(_item) for _item in obj["subCategories"]] if obj.get("subCategories") is not None else None
        })
        return _obj
