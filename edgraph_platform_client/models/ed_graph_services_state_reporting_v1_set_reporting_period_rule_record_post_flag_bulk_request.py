...
class EdGraphServicesStateReportingV1SetReportingPeriodRuleRecordPostFlagBulkRequest(BaseModel):
    """
    ...
    records: Optional[List[EdGraphServicesStateReportingV1SetReportingPeriodRuleRecordPostFlagBulkRequestTypesRecord]] = None
    __properties: ClassVar[List[str]] = ["tenantId", "environmentId", "reportingPeriodId", "ruleId", "records"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [EdGraphServicesStateReportingV1SetReportingPeriodRuleRecordPostFlagBulkRequestTypesRecord.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
