...
class EdGraphServicesStateReportingV1SubmissionMetricsAddedBulkResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "environmentId", "reportingPeriodId", "submissionId"]
