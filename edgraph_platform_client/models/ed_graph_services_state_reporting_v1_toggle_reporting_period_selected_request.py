...
class EdGraphServicesStateReportingV1ToggleReportingPeriodSelectedRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "environmentId", "reportingPeriodId", "selected"]
