...
class EdGraphServicesStateReportingV1UpdateEnvironmentRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "environmentId", "dbEnvironmentId", "edFiInstanceId", "mode", "workspaceName"]
