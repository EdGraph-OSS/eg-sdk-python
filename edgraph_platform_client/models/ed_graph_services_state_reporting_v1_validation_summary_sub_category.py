...
class EdGraphServicesStateReportingV1ValidationSummarySubCategory(BaseModel):
    """
    EdGraphServicesStateReportingV1ValidationSummarySubCategory
    """ # noqa: E501
    sub_category: Optional[EdGraphServicesStateReportingV1SubCategory] = Field(default=None, alias="subCategory")
    rules: Optional[List[EdGraphServicesStateReportingV1Rule]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subCategory": EdGraphServicesStateReportingV1SubCategory.from_dict(obj["subCategory"]) if obj.get("subCategory") is not None else None,
            "rules": [EdGraphServicesStateReportingV1Rule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
