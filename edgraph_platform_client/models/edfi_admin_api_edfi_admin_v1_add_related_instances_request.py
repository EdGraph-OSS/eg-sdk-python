...
class EdfiAdminApiEdfiAdminV1AddRelatedInstancesRequest(BaseModel):
    """
    ...
    related_instance_ids: Optional[List[StrictStr]] = Field(default=None, alias="relatedInstanceIds")
    __properties: ClassVar[List[str]] = ["tenantId", "instanceId", "relatedInstanceIds"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if related_instance_ids (nullable) is None
        # and model_fields_set contains the field
        if self.related_instance_ids is None and "related_instance_ids" in self.model_fields_set:
            _dict['relatedInstanceIds'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relatedInstanceIds": obj.get("relatedInstanceIds")
        })
        return _obj
