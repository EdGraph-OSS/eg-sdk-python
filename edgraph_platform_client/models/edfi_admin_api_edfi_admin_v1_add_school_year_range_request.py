...
class EdfiAdminApiEdfiAdminV1AddSchoolYearRangeRequest(BaseModel):
    """
    ...
    entries: Optional[List[EdfiAdminApiEdfiAdminV1AddSchoolYearRangeRequestEntry]] = None
    __properties: ClassVar[List[str]] = ["tenantId", "instanceId", "entries"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entries": [EdfiAdminApiEdfiAdminV1AddSchoolYearRangeRequestEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
