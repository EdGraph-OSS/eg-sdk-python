...
class EdfiAdminApiEdfiAdminV1ChangeDatabaseTierRequest(BaseModel):
    """
    ...
    selected_tier: Optional[EdfiAdminApiEdfiAdminV1DatabaseTier] = Field(default=None, alias="selectedTier")
    __properties: ClassVar[List[str]] = ["instanceId", "tenantId", "year", "selectedTier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "year": obj.get("year"),
            "selectedTier": obj.get("selectedTier")
        })
        return _obj
