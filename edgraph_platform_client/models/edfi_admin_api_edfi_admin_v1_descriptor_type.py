...
class EdfiAdminApiEdfiAdminV1DescriptorType(BaseModel):
    """
    EdfiAdminApiEdfiAdminV1DescriptorType
    """ # noqa: E501
    descriptor_id: Optional[StrictInt] = Field(default=None, alias="descriptorId")
    ...
    __properties: ClassVar[List[str]] = ["descriptorId", "namespace", "codeValue", "shortDescription", "description"]
