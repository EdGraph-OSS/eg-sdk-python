...
class EdfiAdminApiEdfiAdminV1EdFiConnection(BaseModel):
    """
    ...
    tiers: Optional[List[EdfiAdminApiEdfiAdminV1EdFiConnectionTier]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tiers": [EdfiAdminApiEdfiAdminV1EdFiConnectionTier.from_dict(_item) for _item in obj["tiers"]] if obj.get("tiers") is not None else None,
