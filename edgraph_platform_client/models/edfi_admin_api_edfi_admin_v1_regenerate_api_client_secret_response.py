...
class EdfiAdminApiEdfiAdminV1RegenerateApiClientSecretResponse(BaseModel):
    """
    ...
    new_secret: Optional[StrictStr] = Field(default=None, alias="newSecret")
    __properties: ClassVar[List[str]] = ["tenantId", "instanceId", "apiClientId", "newSecret"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if new_secret (nullable) is None
        # and model_fields_set contains the field
        if self.new_secret is None and "new_secret" in self.model_fields_set:
            _dict['newSecret'] = None
