...
class EdfiAdminApiEdfiAdminV1SpecificationsExportedResponse(BaseModel):
    """
    ...
    type: Optional[EdfiAdminApiEdfiAdminV1ExportType] = None
    status: Optional[EdfiAdminApiEdfiAdminV1ExportStatus] = None
    details: Optional[StrictStr] = None
    contents: Optional[List[StrictInt]] = None
    __properties: ClassVar[List[str]] = ["id", "tenantId", "instanceId", "type", "status", "details", "contents"]
