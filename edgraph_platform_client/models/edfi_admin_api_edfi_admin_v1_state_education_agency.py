...
class EdfiAdminApiEdfiAdminV1StateEducationAgency(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "stateEducationAgencyId", "nameOfInstitution", "educationOrganizationCategoryDescriptors"]
