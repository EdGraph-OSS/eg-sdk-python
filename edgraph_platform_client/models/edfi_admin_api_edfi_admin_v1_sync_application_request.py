...
class EdfiAdminApiEdfiAdminV1SyncApplicationRequest(BaseModel):
    """
    ...
    assign_to_existing_leas: Optional[StrictBool] = Field(default=None, alias="assignToExistingLeas")
    __properties: ClassVar[List[str]] = ["tenantId", "instanceId", "year", "applicationId", "entries", "assignToExistingLeas"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assignToExistingLeas": obj.get("assignToExistingLeas")
        })
        return _obj
