...
class EdfiAdminApiEdfiAdminV1Vendor(BaseModel):
    """
    Common Objects
    """ # noqa: E501
    ...
    applications: Optional[List[StrictInt]] = Field(default=None, description="TODO: Changed from application object to applicationId's to remove cyclic structure")
    namespace_prefixes: Optional[List[StrictStr]] = Field(default=None, alias="namespacePrefixes")
    __properties: ClassVar[List[str]] = ["vendorId", "vendorName", "applications", "namespacePrefixes"]
