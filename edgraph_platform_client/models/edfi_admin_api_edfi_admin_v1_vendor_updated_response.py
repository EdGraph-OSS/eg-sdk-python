...
class EdfiAdminApiEdfiAdminV1VendorUpdatedResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "instanceId", "vendorId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EdfiAdminApiEdfiAdminV1VendorUpdatedResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EdfiAdminApiEdfiAdminV1VendorUpdatedResponse from a dict"""
        if obj is None:
            return None
