...
class EnrollmentApiEnrollmentApplicationResponsesV1ApplicationResponseContactMessage(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "sourceId", "name", "phone", "email"]
