...
class EvaluationApiEvaluationSettingsV1FormConfigurationResponse(BaseModel):
    """
    EvaluationApiEvaluationSettingsV1FormConfigurationResponse
    """ # noqa: E501
    form_id: Optional[StrictStr] = Field(default=None, alias="formId")
    versions: Optional[List[EvaluationApiEvaluationSettingsV1FormVersionConfigurationResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [EvaluationApiEvaluationSettingsV1FormVersionConfigurationResponse.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
