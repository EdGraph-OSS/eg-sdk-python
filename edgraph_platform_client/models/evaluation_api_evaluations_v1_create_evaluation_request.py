...
class EvaluationApiEvaluationsV1CreateEvaluationRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "evaluationDate", "campus", "appraiserUserId", "staffUserId", "formId", "formVersion", "campusClassId"]
