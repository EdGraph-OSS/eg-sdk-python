...
class EvaluationApiEvaluationsV1OrganizationDiscriminator(str, Enum):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EvaluationApiEvaluationsV1OrganizationDiscriminator from a JSON string"""
