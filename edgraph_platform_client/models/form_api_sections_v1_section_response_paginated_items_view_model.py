...
class FormApiSectionsV1SectionResponsePaginatedItemsViewModel(BaseModel):
    """
    ...
    data: Optional[List[FormApiSectionsV1SectionResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "data": [FormApiSectionsV1SectionResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
