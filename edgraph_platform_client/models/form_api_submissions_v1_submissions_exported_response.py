...
class FormApiSubmissionsV1SubmissionsExportedResponse(BaseModel):
    """
    ...
    status: Optional[FormApiSubmissionsV1ExportStatus] = None
    details: Optional[StrictStr] = None
    contents: Optional[List[StrictInt]] = None
    __properties: ClassVar[List[str]] = ["formId", "tenantId", "type", "status", "details", "contents"]
