...
class GoogleProtobufWellKnownTypesStruct(BaseModel):
    """
    GoogleProtobufWellKnownTypesStruct
    """ # noqa: E501
    fields: Optional[Dict[str, GoogleProtobufWellKnownTypesValue]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": dict(
                (_k, GoogleProtobufWellKnownTypesValue.from_dict(_v))
...
GoogleProtobufWellKnownTypesStruct.model_rebuild(raise_errors=False)
