...
class IdentityApiInstructionalInsightsV1JobExecutionMessage(BaseModel):
    """
    ...
    queue_date_time: Optional[StrictStr] = Field(default=None, alias="queueDateTime")
    ...
    __properties: ClassVar[List[str]] = ["executionId", "status", "queueDateTime", "startDateTime", "endDateTime", "input", "output"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if queue_date_time (nullable) is None
        # and model_fields_set contains the field
        if self.queue_date_time is None and "queue_date_time" in self.model_fields_set:
            _dict['queueDateTime'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queueDateTime": obj.get("queueDateTime"),
