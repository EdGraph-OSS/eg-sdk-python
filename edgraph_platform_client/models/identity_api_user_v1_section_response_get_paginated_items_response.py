...
class IdentityApiUserV1SectionResponseGetPaginatedItemsResponse(BaseModel):
    """
    ...
    data: Optional[List[IdentityApiUserV1SectionResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [IdentityApiUserV1SectionResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "count": obj.get("count")
        })
        return _obj
