...
class IdentityApiUserV1UpdateSectionBulkRequest(BaseModel):
    """
    IdentityApiUserV1UpdateSectionBulkRequest
    """ # noqa: E501
    user_id: Optional[StrictStr] = Field(default=None, alias="userId")
    tenant_id: Optional[StrictStr] = Field(default=None, alias="tenantId")
    sections: Optional[List[IdentityApiUserV1UpdateSectionBulkRequestTypesSectionDto]] = None
    __properties: ClassVar[List[str]] = ["userId", "tenantId", "sections"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sections": [IdentityApiUserV1UpdateSectionBulkRequestTypesSectionDto.from_dict(_item) for _item in obj["sections"]] if obj.get("sections") is not None else None
        })
        return _obj
