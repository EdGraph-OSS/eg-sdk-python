...
class IdentityApiUserV1UserListResponse(BaseModel):
    """
    ...
    tenants: Optional[List[IdentityApiUserV1Tenant]] = None
    ...
    logins: Optional[List[IdentityApiUserV1UserLogin]] = None
    ...
    __properties: ClassVar[List[str]] = ["userId", "userName", "email", "firstName", "lastName", "tenantCount", "tenants", "createdBy", "createdDateTime", "lastModifiedBy", "lastModifiedDateTime", "logins", "source", "lastLoginDateTime", "mfaCompleted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tenants": [IdentityApiUserV1Tenant.from_dict(_item) for _item in obj["tenants"]] if obj.get("tenants") is not None else None,
            "createdBy": obj.get("createdBy"),
            "createdDateTime": obj.get("createdDateTime"),
            "lastModifiedBy": obj.get("lastModifiedBy"),
            "lastModifiedDateTime": obj.get("lastModifiedDateTime"),
            "logins": [IdentityApiUserV1UserLogin.from_dict(_item) for _item in obj["logins"]] if obj.get("logins") is not None else None,
