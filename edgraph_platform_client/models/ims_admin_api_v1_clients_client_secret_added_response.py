...
class IMSAdminApiV1ClientsClientSecretAddedResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "applicationId", "clientId", "secretValue", "description", "expiration"]
