...
class IMSAdminApiV1ConnectionsConnectionDetails(BaseModel):
    """
    IMSAdminApiV1ConnectionsConnectionDetails
    """ # noqa: E501
    type: Optional[StrictStr] = None
    metadata: Optional[List[IMSAdminApiV1ConnectionsConnectionDetailsMetadata]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "metadata": [IMSAdminApiV1ConnectionsConnectionDetailsMetadata.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None
        })
        return _obj
