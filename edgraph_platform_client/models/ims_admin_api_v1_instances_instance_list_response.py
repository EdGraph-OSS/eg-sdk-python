...
class IMSAdminApiV1InstancesInstanceListResponse(BaseModel):
    ...
    connection: Optional[IMSAdminApiV1ConnectionsConnectionListResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connection": IMSAdminApiV1ConnectionsConnectionListResponse.from_dict(obj["connection"]) if obj.get("connection") is not None else None,
