...
class TenantApiIntegrationsV1GetIntegrationResponse(BaseModel):
    """
    TenantApiIntegrationsV1GetIntegrationResponse
    """ # noqa: E501
    integration: Optional[TenantApiIntegrationsV1Integration] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integration": TenantApiIntegrationsV1Integration.from_dict(obj["integration"]) if obj.get("integration") is not None else None
        })
        return _obj
