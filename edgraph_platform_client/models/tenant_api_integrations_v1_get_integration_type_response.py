...
class TenantApiIntegrationsV1GetIntegrationTypeResponse(BaseModel):
    """
    TenantApiIntegrationsV1GetIntegrationTypeResponse
    """ # noqa: E501
    integration_type: Optional[TenantApiIntegrationsV1IntegrationType] = Field(default=None, alias="integrationType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integrationType": TenantApiIntegrationsV1IntegrationType.from_dict(obj["integrationType"]) if obj.get("integrationType") is not None else None
        })
        return _obj
