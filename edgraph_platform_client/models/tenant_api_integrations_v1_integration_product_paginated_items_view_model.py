...
class TenantApiIntegrationsV1IntegrationProductPaginatedItemsViewModel(BaseModel):
    """
    ...
    data: Optional[List[TenantApiIntegrationsV1IntegrationProduct]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "data": [TenantApiIntegrationsV1IntegrationProduct.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
