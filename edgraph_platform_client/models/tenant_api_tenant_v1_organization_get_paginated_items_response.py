...
class TenantApiTenantV1OrganizationGetPaginatedItemsResponse(BaseModel):
    """
    ...
    data: Optional[List[TenantApiTenantV1Organization]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [TenantApiTenantV1Organization.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "count": obj.get("count")
        })
        return _obj
