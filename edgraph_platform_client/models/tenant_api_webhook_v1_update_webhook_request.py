...
class TenantApiWebhookV1UpdateWebhookRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "tenantId", "name", "url", "secretHeader", "secretValue", "contentType", "status", "eventSubscriptions", "subscriptions", "webhookSchema"]
