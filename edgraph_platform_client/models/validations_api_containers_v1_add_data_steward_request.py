...
class ValidationsApiContainersV1AddDataStewardRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "collectionId", "email", "firstName", "lastName", "userId", "reportingPeriodId", "environmentId"]
