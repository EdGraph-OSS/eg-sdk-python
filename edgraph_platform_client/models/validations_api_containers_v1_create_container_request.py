...
class ValidationsApiContainersV1CreateContainerRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "name", "description", "environmentType", "tags", "parentContainerId", "environmentId", "urls"]
