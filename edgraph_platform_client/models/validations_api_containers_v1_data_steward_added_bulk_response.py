...
class ValidationsApiContainersV1DataStewardAddedBulkResponse(BaseModel):
    """
    ValidationsApiContainersV1DataStewardAddedBulkResponse
    """ # noqa: E501
    tenant_id: Optional[StrictStr] = Field(default=None, alias="tenantId")
    collections: Optional[List[ValidationsApiContainersV1DataStewardAddedBulkResponseTypesCollection]] = None
    reporting_period_id: Optional[StrictStr] = Field(default=None, alias="reportingPeriodId")
    __properties: ClassVar[List[str]] = ["tenantId", "collections", "reportingPeriodId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "collections": [ValidationsApiContainersV1DataStewardAddedBulkResponseTypesCollection.from_dict(_item) for _item in obj["collections"]] if obj.get("collections") is not None else None,
