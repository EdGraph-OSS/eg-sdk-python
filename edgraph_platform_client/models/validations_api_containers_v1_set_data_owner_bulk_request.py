...
class ValidationsApiContainersV1SetDataOwnerBulkRequest(BaseModel):
    """
    ValidationsApiContainersV1SetDataOwnerBulkRequest
    """ # noqa: E501
    tenant_id: Optional[StrictStr] = Field(default=None, alias="tenantId")
    collections: Optional[List[ValidationsApiContainersV1SetDataOwnerBulkRequestTypesCollection]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "collections": [ValidationsApiContainersV1SetDataOwnerBulkRequestTypesCollection.from_dict(_item) for _item in obj["collections"]] if obj.get("collections") is not None else None,
