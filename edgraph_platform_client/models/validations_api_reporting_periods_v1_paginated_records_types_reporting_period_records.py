...
class ValidationsApiReportingPeriodsV1PaginatedRecordsTypesReportingPeriodRecords(BaseModel):
    """
    ValidationsApiReportingPeriodsV1PaginatedRecordsTypesReportingPeriodRecords
    """ # noqa: E501
    rule: Optional[ValidationsApiReportingPeriodsV1PaginatedRecordsTypesReportingPeriodRecordsTypesRule] = None
    records: Optional[List[ValidationsApiReportingPeriodsV1ValidationResultRecord]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rule": ValidationsApiReportingPeriodsV1PaginatedRecordsTypesReportingPeriodRecordsTypesRule.from_dict(obj["rule"]) if obj.get("rule") is not None else None,
            "records": [ValidationsApiReportingPeriodsV1ValidationResultRecord.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
