...
class ValidationsApiRulesV1PaginatedRules(BaseModel):
    """
    ...
    data: Optional[List[ValidationsApiRulesV1RuleDto]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "data": [ValidationsApiRulesV1RuleDto.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
