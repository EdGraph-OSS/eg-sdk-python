...
with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a list of Authorization Strategies.
        api_response = api_instance.get_authorization_strategies_async(tenant_id, instance_id, page_index=page_index, page_size=page_size, order_by=order_by, filter=filter)
