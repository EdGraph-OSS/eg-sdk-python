...
with edgraph_platform_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a list of DataSync Job Executions
        api_response = api_instance.get_all_tenant_data_sync_job_executions(tenant_id, job_id, page_size=page_size, page_index=page_index, order_by=order_by, filter=filter)
