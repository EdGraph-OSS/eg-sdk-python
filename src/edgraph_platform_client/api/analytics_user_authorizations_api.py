...
class AnalyticsUserAuthorizationsApi:
    ...
    def get_paginated_user_authorizations(
        ...
        _param = self._get_paginated_user_authorizations_serialize(
            tenant_id=tenant_id,
            page_size=page_size,
    ...
    def get_paginated_user_authorizations_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AnalyticsApiUserAuthorizationsV1UserAuthorizationsPaginatedItemsResponse]:
        """Retrieves paginated user authorizations
    ...
    def _get_paginated_user_authorizations_serialize(
        self,
        tenant_id,
        page_size,
        page_index,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/analytics/userauthorizations',
    ...
    def soft_delete_user_authorization(
        ...
        :param tenant_id:  (required)
        :type tenant_id: str
        :param user_authorization_id:  (required)
        :type user_authorization_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._soft_delete_user_authorization_serialize(
            tenant_id=tenant_id,
    ...
    def soft_delete_user_authorization_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AnalyticsApiUserAuthorizationsV1UserAuthorizationSoftDeletedResponse]:
        """Soft Deletes a user authorization by Id
    ...
    def _soft_delete_user_authorization_serialize(
        self,
        tenant_id,
        ...
        if tenant_id is not None:
            _path_params['tenantId'] = tenant_id
        if user_authorization_id is not None:
            _path_params['userAuthorizationId'] = user_authorization_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/tenants/{tenantId}/analytics/userauthorizations/{userAuthorizationId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
