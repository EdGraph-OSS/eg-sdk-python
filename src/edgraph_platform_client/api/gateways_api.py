...
class GatewaysApi:
    ...
    def get_all_analytics_gateways_async(
        ...
        _param = self._get_all_analytics_gateways_async_serialize(
            tenant_id=tenant_id,
    ...
    def _get_all_analytics_gateways_async_serialize(
        self,
        tenant_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/analytics/gateways',
