...
class JobTypesApi:
    ...
    def get_all_tenant_data_sync_job_types(
        ...
        _param = self._get_all_tenant_data_sync_job_types_serialize(
            tenant_id=tenant_id,
            page_size=page_size,
    ...
    def get_all_tenant_data_sync_job_types_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DataSyncApiJobTypeV1JobTypeListResponsePaginatedItemsViewModel]:
        """Retrieves a list of DataSync job types
    ...
    def _get_all_tenant_data_sync_job_types_serialize(
        self,
        tenant_id,
        page_size,
        page_index,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/datasync/jobtypes',
    ...
    def get_tenant_data_sync_job_type_profile_by_id(
        ...
        _param = self._get_tenant_data_sync_job_type_profile_by_id_serialize(
            tenant_id=tenant_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '403': "EdGraphCommonErrorsCoreProblemDetails",
            '500': "EdGraphCommonErrorsCoreProblemDetails",
            '200': "DataSyncApiJobTypeV1JobTypeProfileResponse",
            '400': "MicrosoftAspNetCoreMvcProblemDetails",
    ...
    def get_tenant_data_sync_job_type_profile_by_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DataSyncApiJobTypeV1JobTypeProfileResponse]:
        """Retrieves a specific DataSync job type using its primary key
    ...
    def _get_tenant_data_sync_job_type_profile_by_id_serialize(
        self,
        tenant_id,
        job_type_id,
        _request_auth,
        ...
        if job_type_id is not None:
            _path_params['jobTypeId'] = job_type_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenants/{tenantId}/datasync/jobtypes/{jobTypeId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
