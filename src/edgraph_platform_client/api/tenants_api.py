...
class TenantsApi:
    ...
    def get_tenant_by_id_async(
        ...
        _param = self._get_tenant_by_id_async_serialize(
            tenant_id=tenant_id,
    ...
    def get_tenant_by_id_async_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TenantApiTenantV1TenantProfileResponse]:
        """Retrieves the profile of a specific tenant
    ...
    def _get_tenant_by_id_async_serialize(
        self,
        tenant_id,
        _request_auth,
        _content_type,
    ...
    def update_tenant_async(
        ...
        :param tenant_id:  (required)
        :type tenant_id: str
        :param ed_graph_http_aggregators_tenant_api_controllers_v1_view_models_requests_tenants_update_tenant_request: 
        :type ed_graph_http_aggregators_tenant_api_controllers_v1_view_models_requests_tenants_update_tenant_request: EdGraphHttpAggregatorsTenantApiControllersV1ViewModelsRequestsTenantsUpdateTenantRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_tenant_async_serialize(
            tenant_id=tenant_id,
            ed_graph_http_aggregators_tenant_api_controllers_v1_view_models_requests_tenants_update_tenant_request=ed_graph_http_aggregators_tenant_api_controllers_v1_view_models_requests_tenants_update_tenant_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_tenant_async_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if ed_graph_http_aggregators_tenant_api_controllers_v1_view_models_requests_tenants_update_tenant_request is not None:
            _body_params = ed_graph_http_aggregators_tenant_api_controllers_v1_view_models_requests_tenants_update_tenant_request
