...
class DataSyncApiConnectionV1ConnectionListResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "connectionId", "name", "providerId", "providerName", "connectionTypeId", "connectionTypeName", "createdBy", "createdDateTime", "lastModifiedBy", "lastModifiedDateTime"]
