...
class DataSyncApiJobExecutionV1JobExecutionListResponsePaginatedItemsViewModel(BaseModel):
    """
    ...
    data: Optional[List[DataSyncApiJobExecutionV1JobExecutionListResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "data": [DataSyncApiJobExecutionV1JobExecutionListResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
