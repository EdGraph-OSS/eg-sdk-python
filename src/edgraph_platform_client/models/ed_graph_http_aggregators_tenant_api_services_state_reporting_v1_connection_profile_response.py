...
class EdGraphHttpAggregatorsTenantApiServicesStateReportingV1ConnectionProfileResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "displayName", "tenantId", "environmentId", "server", "username", "database", "password", "authUrl", "resourcesUrl", "apiKey", "apiSecret", "instanceType"]
