...
class EdGraphPlatformHttpAggregatorsTenantApiControllersV1ViewModelsResponsesUserTenant(BaseModel):
    """
    EdGraphPlatformHttpAggregatorsTenantApiControllersV1ViewModelsResponsesUserTenant
    """ # noqa: E501
    tenant_id: Optional[StrictStr] = Field(default=None, alias="tenantId")
    status: Optional[EdGraphPlatformHttpAggregatorsTenantApiControllersV1ViewModelsResponsesTenantStatus] = None
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "status", "roles", "licenses"]
