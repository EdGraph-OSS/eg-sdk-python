...
class EdGraphServicesStateReportingV1AddSubmissionMetricsBulkRequest(BaseModel):
    """
    ...
    details: Optional[List[EdGraphServicesStateReportingV1SubmissionMetricsDetails]] = None
    __properties: ClassVar[List[str]] = ["tenantId", "environmentId", "reportingPeriodId", "submissionId", "details"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": [EdGraphServicesStateReportingV1SubmissionMetricsDetails.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
