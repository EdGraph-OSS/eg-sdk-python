...
class EdGraphServicesStateReportingV1AddSubmissionMetricsRequest(BaseModel):
    """
    ...
    ed_fi_resource: Optional[StrictStr] = Field(default=None, alias="edFiResource")
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "environmentId", "reportingPeriodId", "submissionId", "edFiResource", "succeededCount", "failedCount"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if ed_fi_resource (nullable) is None
        # and model_fields_set contains the field
        if self.ed_fi_resource is None and "ed_fi_resource" in self.model_fields_set:
            _dict['edFiResource'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "edFiResource": obj.get("edFiResource"),
