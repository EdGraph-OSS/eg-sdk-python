...
class EdGraphServicesStateReportingV1ReportingPeriodValidationsRunDto(BaseModel):
    """
    EdGraphServicesStateReportingV1ReportingPeriodValidationsRunDto
    """ # noqa: E501
    requested_date_time: Optional[StrictStr] = Field(default=None, alias="requestedDateTime")
    ...
    __properties: ClassVar[List[str]] = ["requestedDateTime", "jobExecutionId", "jobId", "status", "queuedDateTime", "startDateTime", "endDateTime"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if requested_date_time (nullable) is None
        # and model_fields_set contains the field
        if self.requested_date_time is None and "requested_date_time" in self.model_fields_set:
            _dict['requestedDateTime'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requestedDateTime": obj.get("requestedDateTime"),
