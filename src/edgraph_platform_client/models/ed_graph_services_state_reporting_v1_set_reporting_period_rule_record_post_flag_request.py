...
class EdGraphServicesStateReportingV1SetReportingPeriodRuleRecordPostFlagRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "environmentId", "reportingPeriodId", "ruleId", "recordId", "excludeFromPost"]
