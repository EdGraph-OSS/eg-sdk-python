...
class EdGraphServicesStateReportingV1SetReportingPeriodStepStatusRequest(BaseModel):
    """
    ...
    status: Optional[EdGraphServicesStateReportingV1ReportingPeriodStepStatus] = None
    __properties: ClassVar[List[str]] = ["tenantId", "environmentId", "reportingPeriodId", "number", "status"]
