...
class EdGraphServicesStateReportingV1SubCategory(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "environmentId", "reportingPeriodId", "categoryId", "subCategoryId", "name", "description"]
