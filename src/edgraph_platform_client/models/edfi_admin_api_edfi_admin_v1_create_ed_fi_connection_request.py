...
class EdfiAdminApiEdfiAdminV1CreateEdFiConnectionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["connectionId", "tenantId", "connectionType", "connectionName", "edFiVersion", "edFiExtension", "metadataUrl", "clientId", "clientSecret", "tokenUrl", "resourcesUrl", "instanceType", "discoveryUrl", "metadataJson"]
