...
class EdfiAdminApiEdfiAdminV1CreateInstanceApiClientRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "instanceId", "instanceApplicationId", "key", "secret"]
