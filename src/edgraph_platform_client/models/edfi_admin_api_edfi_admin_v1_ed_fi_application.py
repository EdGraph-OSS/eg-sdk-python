...
class EdfiAdminApiEdfiAdminV1EdFiApplication(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "applicationId", "applicationName", "claimSetName", "vendorId", "operationalContextUri"]
