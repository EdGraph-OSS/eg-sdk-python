...
class EdfiAdminApiEdfiAdminV1EducationServiceCenter(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "educationServiceCenterId", "nameOfInstitution", "educationOrganizationCategoryDescriptors"]
