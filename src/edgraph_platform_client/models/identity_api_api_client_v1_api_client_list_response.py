...
class IdentityApiApiClientV1ApiClientListResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "clientId", "clientName", "clientUri", "enabled", "createdBy", "createdDateTime", "lastModifiedBy", "lastModifiedDateTime", "expirationDate"]
