...
class IdentityApiInvitationV1InvitationListResponsePaginatedItemsViewModel(BaseModel):
    """
    ...
    data: Optional[List[IdentityApiInvitationV1InvitationListResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "data": [IdentityApiInvitationV1InvitationListResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
