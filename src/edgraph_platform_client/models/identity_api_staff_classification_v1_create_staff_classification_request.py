...
class IdentityApiStaffClassificationV1CreateStaffClassificationRequest(BaseModel):
    """
    ...
    licenses: Optional[List[IdentityApiStaffClassificationV1StaffClassificationLicenseRequest]] = None
    __properties: ClassVar[List[str]] = ["tenantId", "namespace", "codeValue", "shortDescription", "description", "licenses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "licenses": [IdentityApiStaffClassificationV1StaffClassificationLicenseRequest.from_dict(_item) for _item in obj["licenses"]] if obj.get("licenses") is not None else None
        })
        return _obj
