...
class IdentityApiStaffClassificationV1UpdateStaffClassificationRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "namespace", "codeValue", "shortDescription", "description", "licenses"]
