...
class IMSAdminApiV1ClientsClientSecretRegeneratedResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "applicationId", "clientId", "secretValue", "instanceId"]
