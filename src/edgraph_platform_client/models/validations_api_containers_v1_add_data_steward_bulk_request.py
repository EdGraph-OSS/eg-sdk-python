...
class ValidationsApiContainersV1AddDataStewardBulkRequest(BaseModel):
    """
    ValidationsApiContainersV1AddDataStewardBulkRequest
    """ # noqa: E501
    tenant_id: Optional[StrictStr] = Field(default=None, alias="tenantId")
    collections: Optional[List[ValidationsApiContainersV1AddDataStewardBulkRequestTypesCollection]] = None
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "collections", "reportingPeriodId", "environmentId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "collections": [ValidationsApiContainersV1AddDataStewardBulkRequestTypesCollection.from_dict(_item) for _item in obj["collections"]] if obj.get("collections") is not None else None,
