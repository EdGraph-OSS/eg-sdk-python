...
class ValidationsApiContainersV1DataOwnerSetBulkResponse(BaseModel):
    """
    ValidationsApiContainersV1DataOwnerSetBulkResponse
    """ # noqa: E501
    tenant_id: Optional[StrictStr] = Field(default=None, alias="tenantId")
    collections: Optional[List[ValidationsApiContainersV1DataOwnerSetBulkResponseTypesCollection]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "collections": [ValidationsApiContainersV1DataOwnerSetBulkResponseTypesCollection.from_dict(_item) for _item in obj["collections"]] if obj.get("collections") is not None else None,
