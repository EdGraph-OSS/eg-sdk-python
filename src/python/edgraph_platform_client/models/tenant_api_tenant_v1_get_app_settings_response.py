...
class TenantApiTenantV1GetAppSettingsResponse(BaseModel):
    """
    TenantApiTenantV1GetAppSettingsResponse
    """ # noqa: E501
    data: Optional[List[TenantApiTenantV1TenantAppSettings]] = None
    page_index: Optional[StrictInt] = Field(default=None, alias="pageIndex")
    page_size: Optional[StrictInt] = Field(default=None, alias="pageSize")
    count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["data", "pageIndex", "pageSize", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [TenantApiTenantV1TenantAppSettings.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
